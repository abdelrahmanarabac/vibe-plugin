        ...
        <div className="space-y-1.5">
            ...
            <div className="relative group">
                <input
                    ...
                    className="w-full bg-surface-1 border border-surface-2 rounded-xl pl-4 pr-12 py-3 text-sm text-text-primary focus:border-primary/50 focus:ring-1 focus:ring-primary/50 outline-none transition-all placeholder:text-text-dim/50 font-mono"
                    autoFocus
                />
                <button
                    type="button"
